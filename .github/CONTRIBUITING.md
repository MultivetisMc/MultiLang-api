...
1. Fork the repository ([fork](https://github.com/MultivetisMc/MultiLang-api/fork));
...
4. Create a pull request into the version branch being worked on and fill out the template provided ([create a pull request](https://github.com/MultivetisMc/MultiLang-api/pulls));
